...
public class PropsItemRefLoader extends AbstractItemRefLoader {

	public PropsItemRefLoader() {
		super(RefKey.propsitem);
	}

	@Override
	protected void fillNonPropertyDictionary(ItemRef ref, JsonObject refData) {

		String useItemClosure = refData.get("useItemClosure").getAsString();
		ref.addComponentRef(new UseableItemClosureRef(useItemClosure));
