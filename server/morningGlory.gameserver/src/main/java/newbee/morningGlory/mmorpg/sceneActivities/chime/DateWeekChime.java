 ...
 * 限定日期每周某时
 */
public class DateWeekChime extends DateChime {

	// 周几
	private byte dayInWeek;
	
	public DateWeekChime() {}
	
	public DateWeekChime(byte dayInWeek, long startTime, long endTime) {
		this.dayInWeek = dayInWeek;
		super.setStartTimeStamp(startTime);
		super.setEndTimeStamp(endTime);
	}
	...
	public boolean isTheSameDay(final Calendar crtCalendar) {
		...
		if (!super.isTheSameDay(crtCalendar)) {
			return false;
		}
