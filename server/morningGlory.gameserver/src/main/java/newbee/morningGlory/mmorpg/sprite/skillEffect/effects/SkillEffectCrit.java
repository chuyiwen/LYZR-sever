...
public class SkillEffectCrit implements SkillEffect {
	private int hp;
	private FightSprite owner;
	
	public SkillEffectCrit(int hp, FightSprite owner) {
		super();
		this.hp = hp;
		this.owner = owner;
	}
