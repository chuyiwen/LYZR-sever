...
public final class ItemBagPersistenceObject extends AbstractPersistenceObject {
	...
	private static final String SaveDataParameterName = "itemBagData";

	private PersistenceParameter itemBagDataPersistenceParameter = new PersistenceParameter();

	private final ItemBagReadWrite readWrite;

	public ItemBagPersistenceObject(ItemBag itemBag) {
		this.itemBag = itemBag;
		readWrite = new ItemBagReadWrite(itemBag);
	...
	public void snapshot() {
		...
		byte[] bytes = readWrite.toBytes(itemBag);
