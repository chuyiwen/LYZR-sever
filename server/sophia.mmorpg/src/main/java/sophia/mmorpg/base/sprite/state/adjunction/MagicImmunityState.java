 ...
 * 魔法免疫
 */
public class MagicImmunityState extends AdjunctionState {

	public static final short MagicImmunityState_Id = 506;
	
	public MagicImmunityState() {
		super(MagicImmunityState_Id);
