...
import sophia.mmorpg.base.sprite.state.gameEvent.PatrolStateExit_GE;

public class PatrolState extends MovementState {
	public static final short PatrolState_Id = 103;
	public static final String PatrolStateExit_Id = PatrolStateExit_GE.class.getSimpleName();
	
	public PatrolState() {
		super(PatrolState_Id);
	...
	public void exit(FightSprite owner) {
		GameEvent<?> event = GameEvent.getInstance(PatrolStateExit_Id, null);
