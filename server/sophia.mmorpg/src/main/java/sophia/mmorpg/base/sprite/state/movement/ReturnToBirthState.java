...
public class ReturnToBirthState extends MovementState {
	public static final short ReturnToBirthState_Id = 104;

	public ReturnToBirthState() {
		this(ReturnToBirthState_Id);
		addTransition(StopState.StopState_Id);
		addCrossLayerReplacedState(DeadState.DeadState_Id);
	}

	public ReturnToBirthState(short id) {
		super(id);
	}
