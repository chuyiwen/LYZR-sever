...
public final class IdleState extends ActionState {
	public static final short IdleState_Id = 301;
	
	public IdleState() {
		super(IdleState_Id);
		addTransition(DeadState.DeadState_Id, PluckingState.PluckingState_Id);
	}
