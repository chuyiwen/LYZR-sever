 ...
 * 魔法盾
 */
public class MagicShieldState extends AdjunctionState {
	
	public static final short MagicShieldState_Id = 512;
	
	public MagicShieldState() {
		super(MagicShieldState_Id);
