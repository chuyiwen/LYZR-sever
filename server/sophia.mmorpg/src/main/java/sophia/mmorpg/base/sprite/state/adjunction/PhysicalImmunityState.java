 ...
 * 物理免疫
 */
public class PhysicalImmunityState extends AdjunctionState {

	public static final short PhysicalImmunityState_Id = 508;
	
	public PhysicalImmunityState() {
		super(PhysicalImmunityState_Id);
