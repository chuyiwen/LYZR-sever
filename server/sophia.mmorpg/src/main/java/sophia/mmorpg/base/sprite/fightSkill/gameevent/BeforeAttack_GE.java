...
public class BeforeAttack_GE {
	private FightSprite attacker;
	private FightSprite target;

	public static final String BeforeAttackId = BeforeAttack_GE.class.getSimpleName();

	public BeforeAttack_GE(FightSprite attacker, FightSprite target) {
		super();
