...
*/
package sophia.mmorpg.base;

import sophia.game.component.AbstractComponent;
import sophia.game.component.GameObject;

public abstract class ConcreteComponent<T extends GameObject> extends AbstractComponent {
	protected T concreteParent;
	...
	public void setParent(GameObject owner) {
		...
		concreteParent = (T)owner;
	}

	public final T getConcreteParent() {
